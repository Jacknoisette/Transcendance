...
async function write_score(bsize : number, nbr : number, posx : number, posy = (canvas.screen.height / 7)){
...
function draw_background(){
    ...
    const bgContainer = canvas.stage.getChildByName("background") as PIXI.Container;
